  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="flex h-full w-full rounded-xl shadow-lg overflow-hidden">
        {/* Lado izquierdo (rojo con diseño Cinemex) */}
        <div className="w-1/2 bg-red-500 p-12 text-white overflow-y-auto relative">
          ...
          <div className="relative z-10">
            ...
            <p className="mb-8 text-lg">
              Regístrate aquí y empieza a disfrutar la experiencia de ser miembro Cinemex Loop.
            </p>
            ...
            <div className="space-y-4 text-base">
              ...
              <div className="flex items-center">
                ...
                <span>Canjea tus puntos por boletos en la taquilla y productos en dulcería.</span>
              </div>
        ...
        <div className="relative w-1/2 bg-white p-12 overflow-y-auto">
          ...
          <div className="max-w-sm mx-auto pt-8">
            <h2 className="mb-4 text-4xl font-extrabold text-gray-900">¡HOLAAA!</h2>
            <p className="mb-8 text-lg text-gray-600">Ingresa con tu usuario y contraseña.</p>
            ...
            <div className="space-y-6">
              ...
              <button className="w-full rounded-lg bg-gray-300 py-4 text-lg font-semibold text-gray-800 hover:bg-gray-400 transition-colors">
                Ingresar
              </button>
              ...
              <div className="space-y-3">
                ...
                <button className="flex w-full items-center justify-center rounded-lg bg-white-500 py-4 text-lg font-medium text-black hover:bg-blue-50 transition-colors">
                  <Image
